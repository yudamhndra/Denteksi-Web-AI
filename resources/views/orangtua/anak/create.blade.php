                ...
                <div class="col-md-8 mt-5 mx-auto">
                    <div class="card text-center custom-card shadow py-2">
                        ...
                        <div class="row mt-3">
                            ...
                            <button class="btn-create btn btn-submit-col"> GUNAKAN KAMERA
                                <input type="file" name="gambar1" class="form-control" accept="image/*" id="file-input" onchange="readURL(this, 'gigi-depan');">
                            </button>
                            <p class="col mt-1">atau</p>
                            <button class="btn btn-submit-white mt-1"><i class="far fa-image" style="margin-right: 10px;"></i> AMBIL DARI GALERI
                                <input type="file" name="gambar1" class="form-control" accept="image/*" id="file-input" onchange="readURL(this, 'gigi-depan');">
                            </button>
                            </div>
                        </div>
