                    ...
                    <div class="tab-pane fade show  active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="anak" id="anak" data-width="100%">
                                <option value="0" selected disabled>Pilih Anak</option>
                                @foreach($anak as $anak)
                                {{-- Penambahan autocomplete menggunakan id --}}
                                    <option value="{{$anak->id}}" @isset($autoAnak) @if ($anak->nama == $autoAnak->nama) selected @endif @endisset>
                                        {{$anak->nama}}
                                    </option>
                                @endforeach
                            </select>
