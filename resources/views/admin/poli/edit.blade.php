...
<div class="card">
    <div class="card-body">
        <div class="card-title">
            <h4 class="mb-0">Edit Data Layanan Kesehatan</h4>
        </div>
        <hr />
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('klinik.update', $poli->id)}}" method="post" enctype="multipart/form-data" files=true>
                @csrf
                @method('PUT')
                <fieldset class="content-group">
                    <div class="form-group mb-3">
                        <label class="control-label">Layanan Kesehatan <span class="text-danger">*</span></label>
                        <input type="text" name="poli" class="form-control" value="{{$poli->poli}}">
                        @if ($errors->has('poli'))
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="kode_poli" class="form-control" value="{{$poli->kode}}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="waktu" id="waktu" min="1" class="form-control" value="{{$poli->waktu}}">
                        @if ($errors->has('waktu'))
                        <label style="padding-top:7px;color:#F44336;">
                    ...
                    <div id="url-switch" class="form-group d-flex mb-5">
                        ...
                        <div class="form-check form-switch ms-3">
                            <input type="checkbox" class="form-check-input" id="switchHaveURL" name="haveRegUrl" value="{{ $poli->url_registrasi ? 'true' : 'false' }}">
                        </div>
                    </div>
                    <div id="url-reg-external" class="form-group mb-5">
                        ...
                        <input type="url" name="url_external" id="url_external" class="form-control" value="{{$poli->url_registrasi}}" placeholder="https://">
